...
var jStat = __webpack_require__(8).jStat;
var utils = __webpack_require__(1);
var error = __webpack_require__(0);
...
var utils = __webpack_require__(1);
var error = __webpack_require__(0);
var numbro = __webpack_require__(7);
...
exports.SUBSTITUTE = function(text, old_text, new_text, occurrence) {
  console.error('substituting')
  if (arguments.length < 2) {
    return error.na;
  }
  if (!text || !old_text || !new_text) {
    return text;
  } else if (new_text === '' && occurrence === undefined) {
    text.replace(new RegExp(old_text, 'g'), '');
...
(function () {
    ...
    ************************************/
    ...
    numbro.loadCulturesInNode = function() {
        ...
        var cultures = __webpack_require__(14);
